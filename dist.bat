...
powershell -NoProfile -Command "Remove-Item -Recurse -Path \".\dist\Sarcophagus Patch\Source\Connected Services\""
powershell -NoProfile -Command "Remove-Item -Path \".\dist\Sarcophagus Patch\Source\Sarcophagus_Patch.csproj.user\""
powershell -NoProfile -Command "Get-ChildItem \".\dist\Sarcophagus Patch\Source\" -Recurse -Hidden | Remove-Item -Recurse -Verbose -Force"
